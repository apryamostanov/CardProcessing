...
class T_v22xxx_formatter {
    ...
    String make_tc91_string(Integer i_total_number_of_tcrs, Integer i_total_number_of_transactions) {
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_transaction_component_sequence_n
        l_result_string += "474646" //p_bin
        l_result_string += T_shortcuts.d2s(new Date(), "yy") + T_shortcuts.d2s(new Date(), "D").padLeft(3, "0") //d2s
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padLeft(15, "0") //p_destination_amount
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padLeft(12, "0") //p_number_of_monetary_transactions
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(6, "0") //p_batch_number
        l_result_string += i_total_number_of_tcrs.toString().padLeft(12, "0") //p_number_of_tcrs
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padRight(6, "0")
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(8, " ") //p_center_batch_id
        l_result_string += i_total_number_of_transactions.toString().padLeft(9, "0") //p_number_of_transactions
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padRight(18, "0") //GC_ZERO_INTEGER
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padLeft(15, "0") //p_source_amount
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padRight(15, "0") //GC_ZERO_INTEGER
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padRight(15, "0") //GC_ZERO_INTEGER
        l_result_string += T_s.c().GC_EMPTY_STRING.toString().padRight(15, "0") //GC_ZERO_INTEGER
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(7, "0") //GC_SPACE
    ...
    String make_v22900_string(Integer i_line_number, Integer i_total_record_count) {
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(10, " ")
        l_result_string += i_total_record_count.toString().padLeft(11, "0")
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(93, " ")
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(3, " ")
        l_result_string += "0"
        return l_result_string
    }
    ...
    String make_v22000_string(Integer i_line_number) {
        ...
        l_result_string += T_shortcuts.d2s(new Date(), "yyMMdd")
        l_result_string += "4746460002".padRight(10, " ") //raw data recepient
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(10, " ")
        l_result_string += "VSS".padRight(9, " ")
        l_result_string += T_shortcuts.d2s(new Date(), "yyMMdd").padRight(10, " ")
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(82, " ")
        l_result_string += "0"
        return l_result_string
    }
    ...
    String make_v22261_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        ...
        if (i_merged_vts_log_transaction.get_field("F5") != T_s.c().GC_EMPTY_STRING) {
            l_result_string += (new DecimalFormat(".000000").format(Integer.valueOf(i_merged_vts_log_transaction.get_field("F5")) * 0.016 / 100)).replace(T_s.c().GC_POINT, T_s.c().GC_EMPTY_STRING).padLeft(11, "0")
            //p_reimbursement_fee
            l_result_string += "C".padRight(1, " ") //p_reimbursement_fee_debit_credit_indicator
        } else {
            l_result_string += T_s.c().GC_EMPTY_STRING.padLeft(11, "0") //p_reimbursement_fee
            l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, " ") //p_reimbursement_fee_debit_credit_indicator
        }
        l_result_string += T_s.c().GC_EMPTY_STRING.padLeft(11, "0") //p_cash_back_irf_amount_settlement_currency
        l_result_string += T_s.c().GC_EMPTY_STRING.padLeft(11, "0") //p_transaction_integrity_fee
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, " ") //p_transaction_integrity_fee_debit_credit_indicator
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(92, " ") //GC_SPACE
        l_result_string += "0"
        return l_result_string
    }
    ...
    String make_v22260_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        ...
        l_result_string += T_shortcuts.s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd").format("yy").substring(T_s.c().GC_ONE_CHAR) + T_shortcuts.s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd").format("D").padLeft(3, "0")
        //p_rate_table_date
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F4")).padLeft(12, "0")
        //p_transaction_amount
        l_result_string += i_merged_vts_log_transaction.get_field("F49").padRight(3, " ") //p_transaction_currency_code
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F5")).padLeft(12, "0").padLeft(12, "0")
        //p_settlement_amount
        l_result_string += i_merged_vts_log_transaction.get_field("F50").padRight(3, " ") //p_settlement_currency_code
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F6")).padLeft(12, "0").padLeft(12, "0")
        ...
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F61.2")).padLeft(12, "0")
        //p_cardholder_billing_other_amount
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(18, " ") //p_filler1
        l_result_string += T_shortcuts.format_cobol_number("0").padLeft(9, "0")
        //p_optional_issuer_fee_settlement_currency
        l_result_string += T_shortcuts.format_cobol_number("0").padLeft(9, "0")
        //p_optional_issuer_fee_cardholder_billing_currency
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(18, " ") //p_filler2
        l_result_string += T_shortcuts.format_cobol_number("0").padLeft(9, "0")
        //p_optional_issuer_isa_amount_in_settlement_currency
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(3, " ") //GC_SPACE
        l_result_string += "0"
        return l_result_string
    }
    ...
    String make_v22220_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(2, "0") //p_geo_state_code
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(5, " ") //p_geo_zip_code_five
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(4, " ") //p_geo_zip_code_four
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(3, "0") //p_geo_country_code
        ...
        l_result_string += i_merged_vts_log_transaction.get_field("F52") == T_s.c().GC_EMPTY_STRING ? "0" : "1"
    ...
    String make_v22210_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_giv_flag
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_giv_flag_previous
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_advice_source_flag
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_advice_transaction_flag
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, "0") //p_base_1_bill_flag
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, " ") //p_spend_qualifier_indicator
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(7, " ") //GC_SPACE
        l_result_string += "0" //p_pvs_performed_indicator
        l_result_string += T_shortcuts.d2s(T_shortcuts.s2d(i_merged_vts_log_transaction.get_field("F7"), "MMDDhhmmss"), "MMdd")
        //d2s
        l_result_string += T_shortcuts.d2s(T_shortcuts.s2d(i_merged_vts_log_transaction.get_field("F7"), "MMDDhhmmss"), "HHmmss")
        //d2s
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F61.1")).padLeft(12, "0")
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(3, " ") //p_fee_program_indicator
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(6, " ") //GC_SPACE
        l_result_string += "0"
        return l_result_string
    }
    ...
    String make_v22200_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        ...
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, " ") //p_remote_terminal_indicator
        l_result_string += "S".padRight(1, " ") //p_charge_indicator
        l_result_string += "F".padRight(2, " ") //p_product_id
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(2, " ") //p_business_application_identifier
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(1, " ") //p_source_of_funds
        l_result_string += T_s.c().GC_EMPTY_STRING.padRight(2, " ") //p_product_subtype
        ...
        //p_affiliate_bin
        l_result_string += T_shortcuts.d2s(T_shortcuts.s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd"), "MMddyy").padLeft(6, " ")
        //settlement date
        ...
        l_result_string += T_shortcuts.format_cobol_number(i_merged_vts_log_transaction.get_field("F6")).padLeft(12, "0")
        //p_transaction_amount
