...
class T_v22xxx_formatter  extends T_vsms_base_6_util {
    ...
    @I_black_box("error")
    static String make_v22261_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        ...
        l_adjusted_amount = adjust_decdigits_V22260(i_merged_vts_log_transaction.get_field("F5"), i_merged_vts_log_transaction.get_field("F50"))
    ...
    @I_black_box("error")
    static String make_v22260_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        String l_adjusted_amount
        l_result_string += "3300"
        l_result_string += i_merged_vts_log_transaction.get_field("F2").padLeft(6, "0").substring(0, 6) //BIN
        ...
        l_result_string += s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd").format("yy").substring(GC_ONE_CHAR) + s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd").format("D").padLeft(3, "0")
        //p_rate_table_date
        l_adjusted_amount = adjust_decdigits_V22260(i_merged_vts_log_transaction.get_field("F4"), i_merged_vts_log_transaction.get_field("F49"))
        ...
        l_adjusted_amount = adjust_decdigits_V22260(i_merged_vts_log_transaction.get_field("F6"), i_merged_vts_log_transaction.get_field("F51"))
        l_result_string += format_cobol_number(l_adjusted_amount).padLeft(12, "0")
        ...
        l_result_string += format_cobol_number(i_merged_vts_log_transaction.get_field("F61.2")).padLeft(12, "0")
    ...
    @I_black_box("error")
    static String make_v22230_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        l_result_string += "3300"
        l_result_string += i_merged_vts_log_transaction.get_field("F2").padLeft(6, "0").substring(0, 6) //BIN
        l_result_string += "400082SMSRAWDATA"
    ...
    @I_black_box("error")
    static String make_v22220_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        l_result_string += "3300"
        l_result_string += i_merged_vts_log_transaction.get_field("F2").padLeft(6, "0").substring(0, 6) //BIN
        l_result_string += "400082SMSRAWDATA"
        ...
        l_result_string += i_merged_vts_log_transaction.get_field("F52") == GC_EMPTY_STRING ? "0" : "1"
    ...
    @I_black_box("error")
    static String make_v22210_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        l_result_string += "3300"
        l_result_string += i_merged_vts_log_transaction.get_field("F2").padLeft(6, "0").substring(0, 6) //BIN
        l_result_string += "400082SMSRAWDATA"
        ...
        l_result_string += d2s(s2d(i_merged_vts_log_transaction.get_field("F7"), "MMDDhhmmss"), "MMdd")
        //d2s
        l_result_string += d2s(s2d(i_merged_vts_log_transaction.get_field("F7"), "MMDDhhmmss"), "HHmmss")
        //d2s
        l_result_string += format_cobol_number(i_merged_vts_log_transaction.get_field("F61.1")).padLeft(12, "0")
    ...
    @I_black_box("error")
    static String make_v22200_string(T_merged_vts_log_transaction i_merged_vts_log_transaction, Integer i_line_number) {
        String l_result_string = GC_EMPTY_STRING
        l_result_string += "3300"
        l_result_string += i_merged_vts_log_transaction.get_field("F2").padLeft(6, "0").substring(0, 6) //BIN
        l_result_string += "400082SMSRAWDATA"
        ...
        //p_affiliate_bin
        l_result_string += d2s(s2d(i_merged_vts_log_transaction.get_field("F15"), "MMdd"), "MMddyy").padLeft(6, " ")
        //settlement date
        ...
        l_result_string += format_cobol_number(i_merged_vts_log_transaction.get_field("F6")).padLeft(12, "0")
        //p_transaction_amount
