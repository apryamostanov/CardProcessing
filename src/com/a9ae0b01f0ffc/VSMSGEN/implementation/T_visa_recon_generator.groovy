...
class T_visa_recon_generator extends T_vsms_base_6_util {
    ...
    @I_black_box("error")
    static T_merged_vts_log_transaction merge(T_vts_log_transaction i_vts_log_transaction_one, T_vts_log_transaction i_vts_log_transaction_two) {
        if (i_vts_log_transaction_one.get_mti_message_class() != i_vts_log_transaction_two.get_mti_message_class()) {
            l().log_warning(s.MTI_message_class_mismatch, i_vts_log_transaction_one.get_field("MTI"), i_vts_log_transaction_two.get_field("MTI"))
        }
        if (!["0100", "0110", "0120", "0130", "0200", "0210", "0220", "0230", "0400", "0410", "0420", "0430"].contains(i_vts_log_transaction_one.get_field("MTI"))) {
            l().log_warning(s.Unsupported_MTI, i_vts_log_transaction_one.get_match_key(), i_vts_log_transaction_one.get_field("MTI"))
        }
        if (!["0100", "0110", "0120", "0130", "0200", "0210", "0220", "0230", "0400", "0410", "0420", "0430"].contains(i_vts_log_transaction_two.get_field("MTI"))) {
            l().log_warning(s.Unsupported_MTI, i_vts_log_transaction_two.get_match_key(), i_vts_log_transaction_one.get_field("MTI"))
        }
    ...
    @I_black_box("error")
    static ArrayList<T_merged_vts_log_transaction> merge_vts_log_transactions(ArrayList<T_vts_log_transaction> i_all_unmerged_vts_log_transactions) {
    ...
    @I_black_box("error")
    static void validate_merged_transaction(T_merged_vts_log_transaction i_merged_vts_log_transaction) {
        if (i_merged_vts_log_transaction.get_field("F2") == GC_EMPTY_STRING) {
            l().log_warning(s.Card_number_F002_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
        }
        if (i_merged_vts_log_transaction.get_req().get_mti_message_class() == "02") {
            if (i_merged_vts_log_transaction.get_field("F4") == GC_EMPTY_STRING) {
                l().log_warning(s.F004_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F5") == GC_EMPTY_STRING) {
                l().log_warning(s.F005_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F6") == GC_EMPTY_STRING) {
                l().log_warning(s.F006_is_missing_for_Clearing_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F49") == GC_EMPTY_STRING) {
                l().log_warning(s.F049_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F50") == GC_EMPTY_STRING) {
                l().log_warning(s.F050_is_missing_for_Clearing_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F51") == GC_EMPTY_STRING) {
                l().log_warning(s.F051_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
        } else {
            if (i_merged_vts_log_transaction.get_field("F4") == GC_EMPTY_STRING) {
                l().log_warning(s.F004_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            ...
            if (i_merged_vts_log_transaction.get_field("F6") == GC_EMPTY_STRING) {
                l().log_warning(s.F006_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
            if (i_merged_vts_log_transaction.get_field("F49") == GC_EMPTY_STRING) {
                l().log_warning(s.F049_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
            }
        ...
        if (i_merged_vts_log_transaction.get_field("F62.2") == GC_EMPTY_STRING) {
            l().log_warning(s.F062_2_Transaction_Id_is_missing_for_transaction_with_RRN_Z1_with_request_at_line_Z2_and_response_at_line_Z3, i_merged_vts_log_transaction.get_field("F37"), i_merged_vts_log_transaction.get_req().get_vts_log_line_number(), i_merged_vts_log_transaction.get_resp().get_vts_log_line_number())
        }
    }
